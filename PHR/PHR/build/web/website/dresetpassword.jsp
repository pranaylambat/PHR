                ...
                <center>
                    <div style="widows: 98%;font-size: 13px;line-height: 20px;">
                        ...
                        <div style="float: left;width: 28%">
                            <br/>
                            <br/>
                            <form name="frmRegistration" id="frmRegistration" method="post" action="../DForgot">
                                <div style="width: 90%;height: auto;border: solid 1px gray">
                                    ...
                                    <table>
                                        ...
                                        <tr  style="height: 30px;"><td><input type="email" class="input" required="" autofocus="" maxlength="30" minlength="3" name="email_id"></td></tr>
                                        <tr  style="height: 30px;"><td><label>NAME OF HOME TOWN&nbsp;:&nbsp;</label></td></tr>
                                        <tr  style="height: 30px;"><td><input type="text" class="input" required="" autofocus="" maxlength="30" minlength="3" name="answer" placeholder="secret answer"></td></tr>
